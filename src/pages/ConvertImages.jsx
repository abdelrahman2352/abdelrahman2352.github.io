  ...
  return (
    <Layout>
      ...
      <button onClick={handleConvert} disabled={!files.length || status === 'processing'}
        ...
        {status === 'processing' ? <span className="flex items-center justify-center gap-2"><Loader2 size={18} className="animate-spin-icon" /> جارٍ التحويل...</span> : <span className="flex items-center justify-center gap-2"><ArrowLeftRight size={18} /> تحويل الصور</span>}
      </button>
