...
import { FlipHorizontal2, Loader2, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <Layout>
      ...
      <button onClick={handleProcess} disabled={!files.length || status === 'processing'}
        ...
        {status === 'processing' ? <span className="flex items-center justify-center gap-2"><Loader2 size={18} className="animate-spin-icon" /> جارٍ المعالجة...</span> : <span className="flex items-center justify-center gap-2"><FlipHorizontal2 size={18} /> تدوير / قلب الصور</span>}
      </button>
