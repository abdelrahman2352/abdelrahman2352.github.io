...
export default function AdjustColors() {
  ...
  return (
    <Layout>
      ...
      {status === 'done' && <div className="bg-green-50 border border-green-200 text-green-700 rounded-lg p-4 mb-4">✅ تم الضبط بنجاح!</div>}
      ...
      <button onClick={handleAdjust} disabled={!files.length || status === 'processing'}
        ...
        {status === 'processing' ? '⏳ جارٍ المعالجة...' : '🎨 ضبط الألوان'}
      </button>
